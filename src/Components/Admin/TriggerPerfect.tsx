...
const TriggerPerfect = () => {
  ...
  const getMatches = async () => {
    await axios(
      `localhost:3366/api/predict/642439d6534019165b71cddf/admin-leader-table`,
    )
      // .then((res) => {
      //   return res.json();
      // })
  ...
  return (
    <Container>
      <Wrapper>
        <Title>Viewing this week Winners</Title>
        ...
        <Button
          onClick={() => {
            axios.get(
              `http://localhost:3366/api/predict/${id}/trigger-message`,
            );
          }}
        >
          Trigger Message
